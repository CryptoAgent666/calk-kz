...
export const CALCULATOR_SOURCES: Record<string, CalculatorSource[]> = {
  ...
  'dividend-tax': [NK_RK, KGD],
  'self-employed': [NK_RK, KGD, EGOV],
  'mobile-transfers': [KGD, NK_RK],
  ...
  'recycling-fee': [
    { title: 'Методика расчёта утилизационного платежа (приказ № 448)', url: 'https://adilet.zan.kz/rus/docs/V2100025100' },
    { title: 'Приказ № 54 от 20.03.2026 — новая редакция коэффициентов', url: 'https://adilet.zan.kz/rus/docs/V2600038306' },
...
// KK titles for source labels (RU key -> KK). Registered proper nouns (Отбасы банк, Алматы Су,
// Астана Су Арнасы, Оператор РОП) intentionally omitted -> fall back to their RU/original name.
const SOURCE_TITLE_KK: Record<string, string> = {
  ...
  "КГД МФ РК": "ҚР ҚМ МКД",
  "ЕНПФ": "БЖЗҚ",
  "Национальный Банк РК": "ҚР Ұлттық Банкі",
  "Бюро статистики РК": "ҚР Статистика бюросы",
  "ГФСС РК": "ҚР МӘСҚ",
  "МФЦА (AIFC)": "АХҚО (AIFC)",
  "Налоговый кодекс РК, глава 54": "ҚР Салық кодексі, 54-тарау",
  "НК РК — налог на имущество ст. 62": "ҚР СК — мүлік салығы, 62-бап",
  ...
  "Закон о страховой деятельности": "Сақтандыру қызметі туралы заң",
  "ЕЭК — пороги беспошлинного ввоза": "ЕЭК — баж салынбайтын әкелу шектері",
  "НК РК — налог на ТС": "ҚР СК — КӨ салығы",
  "Закон о финансовом лизинге": "Қаржы лизингі туралы заң",
  "Kolesa.kz — рынок авто": "Kolesa.kz — авто нарығы",
  "КазМунайГаз — цены на топливо": "ҚазМұнайГаз — отын бағалары",
  "КоАП РК": "ҚР Әкімшілік құқық бұзушылық туралы кодексі",
  "НК РК ст. 605 — сбор за номера": "ҚР СК 605-бап — нөмірлер үшін алым",
  "ГОСТ 4754-97 Шины пневматические": "ГОСТ 4754-97 Пневматикалық шиналар",
  "Закон о банках и банковской деятельности": "Банктер және банк қызметі туралы заң",
  "Казахстанский фонд гарантирования депозитов": "Қазақстандық депозиттерге кепілдік беру қоры",
  "Отбасы банк (Жилстройсбербанк)": "Отбасы банк (Тұрғын үй құрылыс жинақ банкі)",
  "Закон о МФО": "МҚҰ туралы заң",
  "Закон о банках": "Банктер туралы заң",
  "Гражданский кодекс РК — предпринимательство": "ҚР Азаматтық кодексі — кәсіпкерлік",
  "Постановление НБРК о ДКН": "ҚР ҰБ-нің БЖК туралы қаулысы",
  "Постановление о пособиях по рождению": "Бала туылуына байланысты жәрдемақылар туралы қаулы",
  "Закон о пенсионном обеспечении": "Зейнетақымен қамсыздандыру туралы заң",
  "Halyk Life — пенсионные аннуитеты": "Halyk Life — зейнетақы аннуитеттері",
  "Закон о государственной адресной соц. помощи": "Мемлекеттік атаулы әлеуметтік көмек туралы заң",
  "Закон об образовательных накоплениях": "Білім беру жинақтары туралы заң",
  "Отбасы банк — ГОНС": "Отбасы банк — МБЖЖ",
  "Судебная практика по алиментам": "Алимент бойынша сот тәжірибесі",
  "Указ Президента о БДО педагогов": "Педагогтердің базалық жалақысы туралы Президент Жарлығы",
  "НК РК, глава 78 — госпошлина": "ҚР СК, 78-тарау — мемлекеттік баж",
  "Судебная система РК": "ҚР сот жүйесі",
  "Нотариальная палата РК": "ҚР Нотариаттық палатасы",
  "Закон о нотариате": "Нотариат туралы заң",
  "ГК РК — наследственное право (раздел 6)": "ҚР АК — мұрагерлік құқық (6-бөлім)",
  "eGov — расторжение брака": "eGov — некені бұзу",
  "Закон о банкротстве физлиц": "Жеке тұлғалардың банкроттығы туралы заң",
  "ГК РК, ст. 951-952": "ҚР АК, 951-952-баптар",
  "СНиП РК 5.03-37-2005 Бетонные конструкции": "ҚР ҚНмЕ 5.03-37-2005 Бетон конструкциялар",
  "СНиП РК 5.02-02-2010 Каменные конструкции": "ҚР ҚНмЕ 5.02-02-2010 Тас конструкциялар",
  "СНиП РК 2.04-21-2004 Тепловая защита зданий": "ҚР ҚНмЕ 2.04-21-2004 Ғимараттардың жылу қорғанысы",
  "Комитет по регулированию ЕРР": "ЕРР реттеу комитеті",
  "KASE — Казахстанская фондовая биржа": "KASE — Қазақстан қор биржасы",
  "Духовное управление мусульман Казахстана": "Қазақстан мұсылмандары діни басқармасы",
  "ДУМК": "ҚМДБ",
  "ДУМК — наследство по шариату": "ҚМДБ — шариғат бойынша мұра",
  "Хадж-комитет ДУМК": "ҚМДБ Қажылық комитеті",
  "Григорианский календарь — правила": "Григориан күнтізбесі — ережелер",
  "Производственный календарь РК": "ҚР өндірістік күнтізбесі",
  "Национальный центр тестирования": "Ұлттық тестілеу орталығы",
  "МНВО РК": "ҚР ҒЖБМ",
  "Земельный кодекс РК": "ҚР Жер кодексі",
  "Krisha.kz — рынок недвижимости": "Krisha.kz — жылжымайтын мүлік нарығы",
  "Krisha.kz — оценка квартир": "Krisha.kz — пәтерлерді бағалау",
};
...
export function getSources(
  ...
  const list = CALCULATOR_SOURCES[calculatorId] ?? [];
  const l = lang ?? (i18n.language === 'kk' ? 'kk' : 'ru');
  if (l !== 'kk') return list;
  return list.map((s) => ({ title: SOURCE_TITLE_KK[s.title] ?? s.title, url: s.url }));
}
