...
// 2016 +14.6, 2017 +7.4, 2018 +6.0, 2019 +5.3, 2020 +6.8, 2021 +8.0, 2022 +15.0,
// 2023 +14.5, 2024 +8.7, 2025 +11.4 (факт; дек/дек 2025 = 12.3%).
// 2026 — ПРОГНОЗ: середина коридора НБРК 9–11% (пересмотрен 05.06.2026) → +10%.
// Сверено 07.2026; НЕ брать ряды bankchart (расходятся с БНС на 0.1–0.7 п.п.).
