...
// Ввод ограничен слайдерами (3 млн и 2 млн ₸/мес): облагаемая база каждой
// работы после ОПВ/ВОСМС/вычета всегда ниже порога, поэтому для внешнего
// совместительства (разные агенты) 10% точны на всём диапазоне. Для
// внутреннего порог считается по суммарному доходу у работодателя и достижим
// только у верхних границ обоих слайдеров одновременно (от ~3.7 млн ₸/мес
// суммарно) — там ИПН занижается на 5% от превышения.
