 ...
 * (порог 0,3‰ — лишь проект приказа МЗ; 05.06.2026 согласование приостановлено).
 ...
 * лишения прав (повторно в течение года, ч. 3-1: 20 суток + 8 лет; 25 суток + 9 лет —
 * это ч. 3-2, повтор случая с причинением вреда).
 */
